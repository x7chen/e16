...
struct ble_devinfo_s
{
	...
	ble_gatts_char_handles_t computers_a_handles;
	ble_gatts_char_handles_t computers_b_handles;
...
typedef void (*callback_t)(uint8_t *content,uint16_t length);
typedef struct{
    ...
    callback_t on_computers_a_update;
    callback_t on_computers_b_update;
